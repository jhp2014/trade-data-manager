...
import type { DailyCandle, DateRange, RawDailyStore, RawDailyReader } from "@trade-data-manager/market";
 ...
 */
export class DrizzleRawDailyCandleRepository implements RawDailyStore, RawDailyReader {
