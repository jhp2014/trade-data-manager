...
describe("grid codec", () => {
    it("encode→decode 왕복이 원본과 deep-equal(널·미확정·크로싱 포함)", () => {
        const grid: PointGrid = {
            ...
            newHighs: [
                { min: 541, open: 10100, high: 10210, low: 10050, close: 10210, tv: "2000000000", cum: "2000000000", maxBefore: 0 },
                { min: 560, open: 10450, high: 10450, low: 10300, close: 10310, tv: "10050000", cum: "2595000000", maxBefore: 10210 },
            ],
            prevBase: 9990.5,
            prevBaseKrx: 9985,
            sessionHigh: { min: 610, price: 10990 },
        };
    ...
    it("무사건·미터치 격자(널 투성이)도 보존된다", () => {
        const grid: PointGrid = { base: null, touch: null, pivots: [], newHighs: [], prevBase: null, prevBaseKrx: null, sessionHigh: { min: 540, price: 100 } };
    ...
    it("튜플 위치 자체를 고정한다 — 왕복만으론 encode·decode 가 같은 방향으로 밀린 걸 못 잡는다", () => {
        const grid: PointGrid = {
            ...
            newHighs: [{ min: 541, open: 1, high: 2, low: 3, close: 4, tv: "5", cum: "6", maxBefore: 1.5 }],
            prevBase: 98,
            prevBaseKrx: 97,
            sessionHigh: { min: 545, price: 9990 },
        };
