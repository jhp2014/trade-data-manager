// core/market/domain/map — 유사도 맵. 축(순서 있는 하나)도 그룹(순서 없는 종류)도 못 담는 **연속적 닮음**.
//
...
import type { ChartRef } from "../review/group.js";
...
/**
 * 맵 말뭉치 — **전 맵을 한 번에**. 축의 listAllLines·그룹의 listAllAttachments 와 같은 판단이다:
