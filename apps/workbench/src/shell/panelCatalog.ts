...
export const PANEL_CATALOG: PanelEntry[] = [
    ...
    { id: "board-filter-1", component: "boardFilter", title: "이슈 필터", plane: "eod" },
    { id: "replay-board-1", component: "replayBoard", title: "복기", plane: "eod" },
    { id: "replay-filter-1", component: "replayFilter", title: "복기 필터", plane: "eod" },
    { id: "chart-1", component: "chart", title: "차트(1)", plane: "eod" },
    { id: "chart-2", component: "chart", title: "차트(2)", plane: "eod" },
    { id: "workset-1", component: "workset", title: "작업셋", plane: "eod" },
