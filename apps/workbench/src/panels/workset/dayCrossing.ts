 ...
 * ⚠ 근거 정정(2026-09-22 실측) — 평가 자체는 0.25~0.47초다. **비싼 건 재료**다: 날짜마다
 * `/day-replay` 13MB 를 받아야 해서 10일 스킵이 130MB 조회가 된다. 결론(한 번에 몇 일씩 건너뛰지
 * 않는다)은 그대로지만 이유가 다르다 — 평가를 싸게 해도 안 없어진다.
