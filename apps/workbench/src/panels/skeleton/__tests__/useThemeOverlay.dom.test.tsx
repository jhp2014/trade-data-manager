...
import { pointSkeletons, type PointSkeleton } from "../skeletonOverlay.js";
import { amountLookupOf } from "../amountLayer.js";
import { useThemeOverlay } from "../useThemeOverlay.js";
import { CODE, DATE, MEMBER, TIME, TIME_MIN, skeletonFeed, themeSnapshot } from "./overlayFixture.js";
...
/** 짚은 타점 선 — 테마를 펼칠 대상. */
const target: PointSkeleton = pointSkeletons(
    skeletonFeed.minute[0].pivots, skeletonFeed.minute[0].prevClose, [{ pk: PK, time: TIME }],
    { key: `${CODE}|${DATE}`, stockCode: CODE, date: DATE },
)[0];
