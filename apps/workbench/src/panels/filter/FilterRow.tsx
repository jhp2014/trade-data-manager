...
//
// 줄은 **요약 한 줄이 기본**이고, 막대(5칸)와 그 아래 수치는 머리글 "막대" 토글로 편다. 읽는 시점이
// 다르기 때문이다: 무엇이 걸렸나(늘) · 얼마나 걸렀나(따져 볼 때). 늘 세 줄이면 목록이 안 훑힌다.
//
...
export function FilterRow({
    ...
    return (
        <div
            ...
            style={{
                padding: showBar ? "3px 6px 5px" : "2px 6px 3px", cursor: "grab",
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, minWidth: 0, paddingBottom: showBar ? 3 : 0 }}>
