...
export type { CurationSyncStatus } from "@trade-data-manager/wire";

export const fetchMirrorStatus = (signal?: AbortSignal): Promise<CurationSyncStatus> =>
    apiGet<CurationSyncStatus>("curation/sync", undefined, signal);
