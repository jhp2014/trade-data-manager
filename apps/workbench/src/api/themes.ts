...
import type { ThemeContext, AssignThemeInput, AssignThemeResult, ThemeMember } from "@trade-data-manager/wire";
...
/** 시트 멤버십 전량 — 테마↔종목 양방향 인덱스(buildThemeIndex)의 원자재. 읽기 시점 현재 상태. */
export const fetchAllThemeMembers = (signal?: AbortSignal): Promise<ThemeMember[]> =>
    apiGet<ThemeMember[]>("theme/members/all", undefined, signal);
