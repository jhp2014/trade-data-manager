...
//
// ## 피드에는 name 이 없다 — 이름의 출처는 이 사전 하나
// 한때 타점 피드는 서버가 이름을 붙여 보냈고(옛 MasterCache.attachNames) 클라는 그걸 안 읽는 과도기를
// 거쳐, 이제 피드에서 name 자체를 뺐다. 두 출처를 다시 만드는 순간 위의 버그가 그대로 돌아온다.
//
