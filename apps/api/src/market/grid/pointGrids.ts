 ...
 *  core `POINT_GRID_RULE_VERSION`(codec.ts — 클라 디코더 가드가 보는 그 값)의 재노출이다(값 두 벌 금지).
 *  9: 2026-09-05 피벗 = 양방향 zigzag 경로 뷰(마디 뷰는 levelViewOf 파생) + 기준 밴드 maxBefore(§10)
...
export const POINT_GRID_CALC_VERSION: number = POINT_GRID_RULE_VERSION;
